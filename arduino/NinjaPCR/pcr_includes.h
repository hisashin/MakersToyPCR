...
#define EEPROM_WIFI_PREV_ERROR_ADDR (EEPROM_WIFI_MDNS_HOST_ADDR+EEPROM_WIFI_MDNS_HOST_MAX_LENGTH+1)

#define EEPROM_OTA_TYPE_ADDR (EEPROM_WIFI_PREV_ERROR_ADDR+1)
